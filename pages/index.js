...
export default function Home() {
  return (
    <div>
      <Head>
        <title>ECommerce.com - index</title>
        <meta name='description' content='ecomnerce.com - my first e-commerce project' />
        <link rel="icone" href="/favicone.ico" />
      </Head>
     
      <Image src="/img.jpg" alt="" width={1000} height={200} className=' px-4 m-auto' />
